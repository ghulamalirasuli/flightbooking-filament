                 ...
                 <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $deposit->accountFrom ? $deposit->accountFrom->account_name_with_category_and_branch : 'Exchange' }}</td>
                                <td>{{ $deposit->accountTo ? $deposit->accountTo->account_name_with_category_and_branch : 'Exchange' }}</td>
                                <td>{{ $deposit->amount }} <br>{{ $deposit->mtcurrency->currency_code ?? '' }}</td>
                                <td>
