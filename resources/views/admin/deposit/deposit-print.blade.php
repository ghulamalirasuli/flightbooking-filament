...
<body>
    ...
    <div class="print-container">
        ...
        {{-- CHANGED: Loop twice without specific labels --}}
        @foreach(range(1, 2) as $index)
            <div class="voucher-copy">
                ...
                <div class="row mb-2 align-items-center">
                    ...
                    <div class="col-4 text-center">
                        <h6 class="fw-bold text-primary m-0" style="letter-spacing: 1px; text-transform: uppercase;">Deposit Voucher</h6>
                    </div>
                ...
                <div class="transaction-card shadow-sm">
                    <div class="row align-items-center">
                        ...
                        <div class="col-5 border-start ps-3">
                            ...
                            <div>
                                <span class="data-label d-block">Total Amount</span>
            ...
            @if($loop->first)
                <div class="cut-line">
                    <span><i class="bi bi-scissors"></i> Cut Here</span>
                </div>
            @endif
        @endforeach
